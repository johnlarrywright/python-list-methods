...
networking.insert(3,'networking')
print(networking)
...
cyber = cyber_attacks.index('WannaCry')
print('The index of WannaCry:', cyber)
...
my_dns_list = dns_list.count(98.105)
print(my_dns_list)
